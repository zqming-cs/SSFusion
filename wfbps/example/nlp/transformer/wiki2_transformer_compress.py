...
# parser.add_argument('--data', type=str, default='/home/user/nlp/data/wikitext-103',
...
try:
    ...
    for epoch in range(1, args.epochs+1):         
        ...
        if hvd.rank() == 0:
            ...
            print('| end of itertaion {:3d} | time: {:5.2f}s | valid loss {:5.4f} | ' 'valid ppl {:8.2f}'.format(epoch, (time.time() - epoch_start_time), val_loss, math.exp(val_loss)))
