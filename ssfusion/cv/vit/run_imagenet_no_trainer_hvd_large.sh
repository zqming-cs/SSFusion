...
# ViT-large
model_name_or_path=${model_name_or_path:-"/data/google/vit-large-patch16-224-in21k"}
...
CMD=" horovodrun   4 -H node15:2,node16:2,node19:2,node20:2  python run_imagenet_no_trainer_hvd.py --image_column_name image   "
